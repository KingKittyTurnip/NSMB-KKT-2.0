    ...
    public class TrackIcon : QuantumSceneViewComponent {
        ...
        public override void OnLateUpdateView() {
            ...
            if (upArrow && downArrow) {
                upArrow.enabled = Camera.main.transform.position.y +3 < targetTransform.position.y;
                downArrow.enabled = Camera.main.transform.position.y -3 > targetTransform.position.y;
            }
        }
    }
}
